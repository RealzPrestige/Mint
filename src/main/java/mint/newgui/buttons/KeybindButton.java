...
public class KeybindButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Mint.textManager.drawStringWithShadow(setting.isOpen ? setting.getName() + " " + Mint.textManager.getIdleSign() : setting.getName() + " " + ChatFormatting.GRAY + setting.getValue().toString().toUpperCase(), x + 2, y, -1);
    }
