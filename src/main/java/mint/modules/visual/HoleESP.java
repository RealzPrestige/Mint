...
public class HoleESP extends Module {
    ...
    public Setting<Integer> updateDelay = register(new Setting<>("UpdateDelay", 1, 0, 30, v -> othersParent.getValue()));
    ...
    public Setting<Integer> bedrockBoxGreen = register(new Setting<>("BedrockBoxGreen", 255, 0, 255, v -> bedrockBox.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockBoxBlue = register(new Setting<>("BedrockBoxBlue", 0, 0, 255, v -> bedrockBox.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockBoxAlpha = register(new Setting<>("BedrockBoxAlpha", 120, 0, 255, v -> bedrockBox.getValue() && bedrockParent.getValue()));
    public Setting<Boolean> bedrockOutline = register(new Setting("BedrockOutline", true, v -> bedrockParent.getValue()));
    public Setting<Integer> bedrockOutlineRed = register(new Setting<>("BedrockOutlineRed", 0, 0, 255, v -> bedrockOutline.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockOutlineGreen = register(new Setting<>("BedrockOutlineGreen", 255, 0, 255, v -> bedrockOutline.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockOutlineBlue = register(new Setting<>("BedrockOutlineBlue", 0, 0, 255, v -> bedrockOutline.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockOutlineAlpha = register(new Setting<>("BedrockOutlineAlpha", 255, 0, 255, v -> bedrockOutline.getValue() && bedrockParent.getValue()));
    public Setting<Integer> bedrockOutlineLineWidth = register(new Setting<>("BedrockOutlineLineWidth", 1, 0, 5, v -> bedrockOutline.getValue() && bedrockParent.getValue()));
    public Setting<Boolean> obsidianParent = register(new Setting("Obsidian", true, false));
    public Setting<Boolean> obsidianBox = register(new Setting("ObsidianBox", true, v -> obsidianParent.getValue()));
    public Setting<Integer> obsidianBoxRed = register(new Setting<>("ObsidianBoxRed", 255, 0, 255, v -> obsidianBox.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianBoxGreen = register(new Setting<>("ObsidianBoxGreen", 0, 0, 255, v -> obsidianBox.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianBoxBlue = register(new Setting<>("ObsidianBoxBlue", 0, 0, 255, v -> obsidianBox.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianBoxAlpha = register(new Setting<>("ObsidianBoxAlpha", 120, 0, 255, v -> obsidianBox.getValue() && obsidianParent.getValue()));
    public Setting<Boolean> obsidianOutline = register(new Setting("ObsidianOutline", true, v -> obsidianParent.getValue()));
    public Setting<Integer> obsidianOutlineRed = register(new Setting<>("ObsidianOutlineRed", 255, 0, 255, v -> obsidianOutline.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianOutlineGreen = register(new Setting<>("ObsidianOutlineGreen", 0, 0, 255, v -> obsidianOutline.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianOutlineBlue = register(new Setting<>("ObsidianOutlineBlue", 0, 0, 255, v -> obsidianOutline.getValue() && obsidianParent.getValue()));
    public Setting<Integer> obsidianOutlineAlpha = register(new Setting<>("ObsidianOutlineAlpha", 255, 0, 255, v -> obsidianOutline.getValue() && obsidianParent.getValue()));
