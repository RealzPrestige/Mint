...
public class CrystalChanger extends Module {
    ...
    public Setting<Integer> red = register(new Setting<>("Red", 255, 0, 255, v -> this.chams.getValue()));
    public Setting<Integer> green = register(new Setting<>("Green", 255, 0, 255, v -> this.chams.getValue()));
    public Setting<Integer> blue = register(new Setting<>("Blue", 255, 0, 255, v -> this.chams.getValue()));
    public Setting<Integer> alpha = register(new Setting<>("Alpha", 150, 0, 255, v -> this.chams.getValue()));
    public Setting<Integer> wallsRed = register(new Setting<>("WallsRed", 255, 0, 255, v -> this.throughwalls.getValue()));
    public Setting<Integer> wallsGreen = register(new Setting<>("WallsGreen", 255, 0, 255, v -> this.throughwalls.getValue()));
    public Setting<Integer> wallsBlue = register(new Setting<>("WallsBlue", 255, 0, 255, v -> this.throughwalls.getValue()));
